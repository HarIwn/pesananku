  ...
  <body>
          ...
          <div class="col-md-12">
            ...
            <div class="category-carousel swiper">
              <div class="swiper-wrapper">
                ...
                <a href="category.html" class="nav-link swiper-slide text-center">
                  <img src="src/vendor/bootstrap/images/category-thumb-4.jpg" class="rounded-circle" alt="Category Thumbnail">
            ...
            <div class="swiper">
              <div class="swiper-wrapper">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="src/vendor/bootstrap/images/product-thumb-13.png" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="src/vendor/bootstrap/images/product-thumb-14.png" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="src/vendor/bootstrap/images/product-thumb-15.png" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="src/vendor/bootstrap/images/product-thumb-16.png" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="src/vendor/bootstrap/images/product-thumb-17.png" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Whole Wheat Sandwich Bread</h3>
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="src/vendor/bootstrap/images/product-thumb-18.png" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Honeycrisp Apples</h3>
    ...
    <section>
      <div class="container-lg">
        ...
        <div class="bg-secondary text-light py-5 my-5" style="background: url('src/vendor/bootstrap/images/banner-newsletter.jpg') no-repeat; background-size: cover;">
          <div class="container">
            ...
            <div class="swiper">
              <div class="swiper-wrapper">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="src/vendor/bootstrap/images/product-thumb-19.png" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
            ...
            <div class="swiper">
              <div class="swiper-wrapper">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="src/vendor/bootstrap/images/product-thumb-20.png" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Sunstar Fresh Melon Juice</h3>
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="src/vendor/bootstrap/images/product-thumb-21.png" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Sunstar Fresh Melon Juice</h3>
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="src/vendor/bootstrap/images/product-thumb-22.png" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="src/vendor/bootstrap/images/product-thumb-23.png" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Sunstar Fresh Melon Juice</h3>
        ...
        <div class="row">
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="src/vendor/bootstrap/images/post-thumbnail-1.jpg" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="src/vendor/bootstrap/images/post-thumbnail-2.jpg" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="src/vendor/bootstrap/images/post-thumbnail-3.jpg" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
            ...
            <div class="row justify-content-center align-items-center">
              <div class="col-md-4">
                ...
                <div class="d-flex gap-2 flex-wrap mb-5">
                  <a href="#" title="App store"><img src="src/vendor/bootstrap/images/img-app-store.png" alt="app-store"></a>
                  <a href="#" title="Google Play"><img src="src/vendor/bootstrap/images/img-google-play.png" alt="google-play"></a>
                </div>
              </div>
              <div class="col-md-5">
                <img src="src/vendor/bootstrap/images/banner-onlineapp.png" alt="phone" class="img-fluid">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer-menu">
              <img src="src/vendor/bootstrap/images/logo.svg" width="240" height="70" alt="logo">
    ...
    <script src="src/vendor/bootstrap/js/script.js"></script>
  </body>
</html>